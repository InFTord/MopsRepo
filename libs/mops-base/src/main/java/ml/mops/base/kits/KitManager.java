    ...
    public static HashMap<String, ItemStack> kitSpecificMapping(String kit) {
        ...
        switch (kit) {
            case "bear" -> {
                ...
                head.addEnchant(Enchantment.WATER_WORKER, 1, true);
                head.addEnchant(Enchantment.OXYGEN, 1, true);
                map.put("h", head);
                ...
                ItemStack leggings = MopsUtils.createItem(Material.CHAINMAIL_LEGGINGS, ChatColor.AQUA + "Ice Bear's Leggings", 1, new String[]{ChatColor.GRAY + "Protects you from knockback."});
